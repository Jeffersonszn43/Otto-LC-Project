...
// Here is the function that provide all functionalities of the web applications
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (window.location.href.includes("BothRobots.html"))
    {
      connectButton1.addEventListener("click", async function () {
        ...
        characteristic.addEventListener("characteristicvaluechanged", (event) => {
          ...
          console.log("Received notification from ESP32:", value);
    ...
    start_Dance.addEventListener("click", function () {
      if (currentMode === "dance") 
      {
        ...
        //for all the logic look for the send comand.
      }
      else
      {
        const Toast = Swal.mixin({
